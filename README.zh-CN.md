...
flowchart TD
  ...
  B --> C["Pulse preview 制品<br/>pulse-conversation-agent-gateway-v0.1.0-preview.11.tgz"]
  B --> D["Developer Assistant 仓库<br/>conversation-agent-dev-assistant"]

  C --> E["客户本地服务包目录<br/>pulse-conversation-agent-gateway-v0.1.0-preview.11/"]
...
按里面的步骤从 https://github.com/Cogit-oergo-sum/pulse-conversation-agent/releases/tag/v0.1.0-preview.11
安装 Pulse Conversation Agent 0.1.0-preview.11。
